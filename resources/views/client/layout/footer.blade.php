                ...
                <div class="auto-container">
                    <div class="row">
                            ...
                            <div class="footer-widget about-widget wow fadeInLeft">
                                <div class="widget-content">
                                    <div class="logo"><a href="#"> <img
                                                src="{{ asset('client/images/logo-2.png') }}" alt=""></a>
                                    </div>
                                    <div class="text mb-0">Feel free to reach out if you want collaborate with us, or
                                        simply chat.</div>
                                </div>
                            </div>
                        ...
                        <div class="footer-column col-lg-3 col-sm-6">
                            <div class="footer-widget info-widget ps-xl-5 ms-xl-5 mb-30 wow fadeInLeft"
                                    ...
                                    <div class="contact-list">
                                        <div class="inner">
                                            ...
                                            <div class="list-info"><a
                                                    ...
                                                    class="__cf_email__"
                                                    data-cfemail="7811161e173801170d0a0f1d1a0b110c1d561b1715">[email&#160;protected]</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="footer-widget info-widget ps-xl-5 ms-xl-5 wow fadeInLeft"
                                data-wow-delay="300ms">
                                    ...
                                    <div class="contact-list">
                                        <div class="inner">
                                            ...
                                            <div class="list-info"><a
                                                    href="https://html.kodesolution.com/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="137a7d757c536a7c6661647671607a67763d707c7e">[email&#160;protected]</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
