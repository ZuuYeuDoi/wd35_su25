                ...
                <form id="checkout-form" action="#">
                    <div class="row mt-30">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input id="checkuot-form-address" type="email" class="form-control"
                                    ...
                                    <div class="mb-3 col-md-6">
                                        ...
                                        <input id="checkuot-form-zip" type="email" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <textarea id="order_comments" class="form-control"
                        ...
                        <div class="col-md-12 mt-30">
                            ...
                            <table class="table table-striped table-bordered tbl-shopping-cart">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="product-thumbnail"><a href="shop-product-details.html"><img
                                                    alt="product" src="{{ asset('client/images/resource/products/1.jpg') }}"></a></td>
                                        <td class="product-name"><a href="shop-product-details.html">Headphone</a> x 2</td>
                                        <td><span class="amount">$36.00</span></td>
                                    </tr>
                                    <tr>
                                        <td class="product-thumbnail"><a href="shop-product-details.html"><img
                                                    alt="product" src="{{ asset('client/images/resource/products/2.jpg') }}"></a></td>
                                        <td class="product-name"><a href="shop-product-details.html">Lagage</a> x 3</td>
                                        <td><span class="amount">$115.00</span></td>
                                    </tr>
                                    <tr>
                                        <td class="product-thumbnail"><a href="shop-product-details.html"><img
                                                    alt="product" src="{{ asset('client/images/resource/products/3.jpg') }}"></a></td>
                                        <td class="product-name"><a href="shop-product-details.html">Watch</a> x 1</td>
                                                        ...
                                                        <div class="field-input message-btn">
                                                            <button type="submit" class="theme-btn btn-style-one"
                                                                data-loading-text="Please wait..."><span
                                                                    class="btn-title">Make Payment</span></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
