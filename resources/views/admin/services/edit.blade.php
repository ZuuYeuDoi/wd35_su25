...
@section('title1', 'Cập nhật Dịch vụ')
@section('content')
    <section role="main" class="content-body">
        <header class="page-header">
            <h2 class="font-weight-bold text-6">Chỉnh sửa dịch vụ</h2>
        </header>
        <div class="row">
            <div class="col">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <select name="status" id="status"
                                            ...
                                            <option value="1"
                                                {{ old('status', $service->status) == 1 ? 'selected' : '' }}>Hoạt động
                                            </option>
                                            <option value="0"
                                                {{ old('status', $service->status) == 0 ? 'selected' : '' }}>Không hoạt
                                                động</option>
                                        </select>
                                        @error('status')
                                            <div class="invalid-feedback">{{ $message }}</div>
