...
@section('title1', 'Thùng rác Dịch vụ')
@section('content')
    <section role="main" class="content-body">
        <header class="page-header">
            <h2 class="font-weight-bold text-6">Danh sách Dịch vụ đã xóa mềm</h2>
        </header>
                                ...
                                <div class="row align-items-center mb-3">
                                    <div class="col-12 col-lg-auto mb-3 mb-lg-0">
                                        <a href="{{ route('services.index') }}">
                                            <button class="btn btn-secondary">Quay lại danh sách Dịch vụ</button>
                                        </a>
                                    </div>
                                            ...
                                            <td>
                                                <form action="{{ route('services.restore', $service->id) }}" method="POST"
                                                    ...
                                                    <button class="btn btn-sm btn-primary"
                                                        onclick="return confirm('Khôi phục dịch vụ?')">Khôi phục</button>
                                                </form>
                                                ...
                                                <form action="{{ route('services.forceDelete', $service->id) }}"
                                                    ...
                                                    <button class="btn btn-sm btn-danger"
                                                        onclick="return confirm('Xóa vĩnh viễn?')">Xóa vĩnh viễn</button>
                                                </form>
                                            </td>
                                        </tr>
                                    @endforeach
