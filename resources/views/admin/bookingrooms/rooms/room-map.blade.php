        ...
        <form action="{{ route('room.map') }}" method="GET">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-md-auto">
                    <input type="date" name="check_in" id="check_in" class="form-control" placeholder="Ngày nhận phòng" value="{{ old('check_in', $startDate ?? '') }}">
                </div>

                <div class="col-md-auto">
                    <input type="date" name="check_out" id="check_out" class="form-control" placeholder="Ngày trả phòng" value="{{ old('check_out', $endDate ?? '') }}">
                </div>
