                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <p class="card-big-info-desc">Add here the product description with all
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Product
                                        Description</label>
                                    <div class="col-lg-7 col-xl-6">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-2-5 col-xl-1-5">
                                ...
                                <p class="card-big-info-desc">Upload your Product image. You can add
                                    multiple images</p>
                            </div>
                            <div class="col-lg-3-5 col-xl-4-5">
                        ...
                        <div class="tabs-modern row" style="min-height: 490px;">
                            <div class="col-lg-2-5 col-xl-1-5">
                                <div class="nav flex-column tabs" id="tab" role="tablist"
                                    ...
                                    <a class="nav-link" id="inventory-tab" data-bs-toggle="pill"
                                        data-bs-target="#inventory" role="tab" aria-controls="inventory"
                                        aria-selected="false">Inventory</a>
                                    <a class="nav-link" id="shipping-tab" data-bs-toggle="pill"
                                        data-bs-target="#shipping" role="tab" aria-controls="shipping"
                                        aria-selected="false">Shipping</a>
                                    <a class="nav-link" id="linked-products-tab" data-bs-toggle="pill"
                                        data-bs-target="#linked-products" role="tab"
                                        aria-controls="linked-products" aria-selected="false">Linked
                                        Products</a>
                                    <a class="nav-link" id="attributes-tab" data-bs-toggle="pill"
                                        data-bs-target="#attributes" role="tab"
                                        aria-controls="attributes">Attributes</a>
                                    <a class="nav-link" id="advanced-tab" data-bs-toggle="pill"
                                        data-bs-target="#advanced" role="tab"
                            ...
                            <div class="col-lg-3-5 col-xl-4-5">
                                <div class="tab-content" id="tabContent">
                                    <div class="tab-pane fade show active" id="price" role="tabpanel"
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Sale
                                                Price ($)</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" class="form-control form-control-modern"
                                    ...
                                    <div class="tab-pane fade" id="inventory" role="tabpanel"
                                        ...
                                        <div class="form-group row align-items-center pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">SKU</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" class="form-control form-control-modern"
                                        ...
                                        <div class="form-group row align-items-center pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Manage
                                                Stock?</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="checkbox">
                                                    <label class="my-2">
                                        ...
                                        <div class="form-group row align-items-center pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Stock
                                                Status</label>
                                            <div class="col-lg-7 col-xl-6">
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Sold
                                                Individually</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="checkbox">
                                                    <label class="my-2">
                                    ...
                                    <div class="tab-pane fade" id="shipping" role="tabpanel"
                                        ...
                                        <div class="form-group row align-items-center pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Weight
                                                (oz)</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" class="form-control form-control-modern"
                                                    name="weight" value="" />
                                        ...
                                        <div class="form-group row align-items-center pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Dimensions
                                                (in)</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <div class="row">
                                                    <div class="col-xl-4 mb-3 mb-xl-0">
                                                        <input type="text"
                                                            ...
                                                            name="dimensionsLength" value=""
                                                            placeholder="Length" />
                                                    </div>
                                                    <div class="col-xl-4 mb-3 mb-xl-0">
                                                        <input type="text"
                                                            class="form-control form-control-modern"
                                                            name="dimensionsWidth" value=""
                                                            placeholder="Width" />
                                                    </div>
                                                    <div class="col-xl-4">
                                                        <input type="text"
                                                            class="form-control form-control-modern"
                                                            name="dimensionsHeight" value=""
                                                            placeholder="Height" />
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Shipping
                                                Class</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <select class="form-control form-control-modern"
                                                    name="shippingclass">
                                                    <option value="in-stock" selected>No Shipping Class
                                                    </option>
                                    ...
                                    <div class="tab-pane fade" id="linked-products" role="tabpanel"
                                        ...
                                        <div class="form-group row align-items-center pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Upsells</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <select multiple data-plugin-selectTwo
                                                    class="form-control form-control-modern" name="upSells"
                                        ...
                                        <div class="form-group row align-items-center">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Cross-sells</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <select multiple data-plugin-selectTwo
                                                    class="form-control form-control-modern"
                                                    name="crossSells"
                                    ...
                                    <div class="tab-pane fade" id="attributes" role="tabpanel"
                                        ...
                                        <div class="ecommerce-attributes-wrapper">
                                            <div
                                                ...
                                                <div class="col-xl-3">
                                                    ...
                                                    <input type="text"
                                                        class="form-control form-control-modern"
                                                        name="attName" value="Size" />
                                                    <div class="checkbox mt-3 mb-3 mb-lg-0">
                                                        <label class="my-2">
                                                            <input type="checkbox" name="attVisible"
                                                                value="1" checked>
                                                ...
                                                <div class="col-xl-6">
                                                    <a href="#"
                                                        class="ecommerce-attribute-remove text-color-danger float-end">Remove</a>
                                                    <label class="control-label">Value(s)</label>
                                                    <textarea class="form-control form-control-modern"
                                                        name="attValue" rows="4"
                                                        placeholder="Enter some text, or some attributes by | separating values">Small|Medium|Big</textarea>
                                                </div>
                                            </div>
                                            <div
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <textarea class="form-control form-control-modern"
                                                        name="attValue" rows="4"
                                                        placeholder="Enter some text, or some attributes by | separating values">Blue|Red|Green</textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row justify-content-center mt-4">
                                            <div class="col-xl-9 text-end">
                                                <a href="#"
                                                    class="ecommerce-attribute-add-new btn btn-primary btn-px-4 btn-py-2">+
                                                    Add New</a>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="tab-pane fade" id="advanced" role="tabpanel"
                                        ...
                                        <div class="form-group row pb-3">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Purchase
                                                Note</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <textarea class="form-control form-control-modern"
                                                    name="purchaseNote" rows="6"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group row align-items-center">
                                            <label
                                                class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Menu
                                                Order</label>
                                            <div class="col-lg-7 col-xl-6">
                                                <input type="text" class="form-control form-control-modern"
                                                    name="menuOrder" value="" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
