                                ...
                                <div class="col">
                                    <div id="dropzone-form-image" class="dropzone-modern dz-square">
                                        <span class="dropzone-upload-message text-center">
                                            ...
                                            <b class="text-color-primary">Kéo thả / Tải lên</b> ảnh tại đây.
                                        </span>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-2-5 col-xl-1-5">
                            ...
                            <h2 class="card-big-info-title">Chi tiết danh mục</h2>
                            <p class="card-big-info-desc">Thêm mô tả và thông tin chi tiết cho danh mục phòng.</p>
                        </div>
                        <div class="col-lg-3-5 col-xl-4-5">
                            <div class="form-group row align-items-center mb-3">
                                <label class="col-lg-5 col-xl-3 control-label text-lg-end mb-0">Tên danh mục</label>
                            ...
                            <div class="form-group row">
                                <label class="col-lg-5 col-xl-3 control-label text-lg-end pt-2 mt-1 mb-0">Mô tả</label>
                                <div class="col-lg-7 col-xl-6">
    ...
    <div class="row action-buttons">
        <div class="col-12 col-md-auto">
            <button type="submit"
                ...
                <i class="bx bx-save text-4 me-2"></i> Lưu danh mục
            </button>
        </div>
        <div class="col-12 col-md-auto px-md-0 mt-3 mt-md-0">
            <a href="/admin/bookingrooms/category"
        ...
        <div class="col-12 col-md-auto ms-md-auto mt-3 mt-md-0 ms-auto">
            <a href="#"
                ...
                <i class="bx bx-trash text-4 me-2"></i> Xóa danh mục
            </a>
        </div>
    </div>
</form>
