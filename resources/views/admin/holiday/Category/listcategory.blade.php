...
<section role="main" class="content-body">
    <header class="page-header">
        <h2 class="font-weight-bold text-6">Danh sách danh mục sự kiện</h2>
    </header>
<div class="row">
	<div class="col">
					...
					<div class="datatable-header">
						<div class="row align-items-center mb-3">
							<div class="col-12 col-lg-auto mb-3 mb-lg-0">
								<a href="/admin/holiday/category/add" class="btn btn-primary btn-md font-weight-semibold btn-py-2 px-4"> Thêm danh mục</a>
							</div>
