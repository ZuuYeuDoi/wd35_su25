...
Route::prefix('admin')->group(function () {
    ...
    Route::controller(BookingRoomController::class)->group(function () {
        ...
        Route::get('/room_order/{id}/extend-day', [BookingRoomController::class, 'showExtendDay'])->name('room_order.extend_day');
    ...
    Route::controller(BillController::class)->group(function () {
        ...
        Route::get('/bills/{id}/temporary', [BillController::class, 'temporary'])->name('bills.temporary');
